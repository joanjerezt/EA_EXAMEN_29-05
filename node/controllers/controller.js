...
/** OK ***/
exports.getStudentByStudies = function (req, res){
    //console.log(req.params.id);
    studentModel.find({studies: req.params.name},
    //studentModel.find({studies : {$elemMatch: {$eq: req.params.name}}},
...
exports.setStudy = function (req, res){

    var query = {_id: req.params.id};
    var update = {$addToSet : {studies : req.body.study}};
    var options = {};
    ...
    studentModel.findOneAndUpdate(query, update, options, function(err, student) {
        ...
        if(student){
            studentModel.findById(student._id).populate('studies').exec().then(function(err, student) {
                if (err){
                    res.send(err);}
                else {
                    res.send(student);
...
exports.removeStudy = function (req, res){
    ...
    var query = {_id: req.params.id};
    var update = {$pull : {studies: req.params.name}};
    var options = {};
    studentModel.findOneAndUpdate(query, update, options, function(err, student) {
        if (err) {
            res.send(err);
...
exports.SubjectsbyStudent = function (req, res) {
    subjectModel.find({
            students: {
                _id: req.params.id
            }
